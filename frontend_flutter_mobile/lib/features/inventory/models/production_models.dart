...
/// production_models.dart` — COPY/ADAPT NEARLY EXACTLY, full file.
///
...
class RecipeLine {
  ...
  factory RecipeLine.fromJson(Map<String, dynamic> json) => RecipeLine(
    ...
    componentQuantity: (json['componentQuantity'] as num?)?.toDouble() ?? 0,
...
class ProductionOrderLine {
  ...
  factory ProductionOrderLine.fromJson(Map<String, dynamic> json) =>
      ProductionOrderLine(
        id: (json['id'] as num?)?.toInt(),
        componentProductId:
            (json['componentProductId'] as num?)?.toInt() ?? 0,
        componentProductNameEn: json['componentProductNameEn'] as String?,
      ...
      AvailabilityCheckResult(
        ...
        components:
            (json['components'] as List<dynamic>?)
                ?.map(
                  (e) =>
                      ComponentAvailability.fromJson(e as Map<String, dynamic>),
                )
                .toList() ??
            [],
      );
