...
/// scanner_relay_role.dart` — COPY/ADAPT EXACTLY. This is the shared
/// protocol/transport layer for the "phone as remote barcode scanner"
/// relay feature: a SEPARATE phone (running `MobilePhoneScannerScreen`)
/// scans barcodes and relays them over a WebSocket to a receiving
/// device's cart (`PhoneScannerReceiverButton`) in real time. Not a
/// singleton/provider — each screen/widget instantiates its own client.
