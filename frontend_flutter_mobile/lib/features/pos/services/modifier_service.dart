...
/// modifier_service.dart` — COPY/ADAPT EXACTLY. Same endpoints, same
/// request/response shapes. Powers the admin "manage modifier groups"
/// screens (list/create/edit/delete groups & options, assign a group to a
/// set of products) — a different feature from the existing sale-time
/// `ProductModifierSheet` picker, which only ever reads
/// `Product.modifierGroups` and never touches this service.
