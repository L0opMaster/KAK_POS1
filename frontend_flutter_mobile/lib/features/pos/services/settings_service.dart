...
/// settings_service.dart` — COPY/ADAPT NEARLY EXACTLY, full file.
class SettingsService {
  ...
  Future<Map<String, dynamic>> updatePosSettings(
    ...
    return _api.put<Map<String, dynamic>>('/api/settings/pos', data: request);
  }
...
/// Invalidate after `updatePosLayout`/`updatePosSettings` to refresh
/// consumers.
final posSettingsProvider = FutureProvider<Map<String, dynamic>>((ref) async {
