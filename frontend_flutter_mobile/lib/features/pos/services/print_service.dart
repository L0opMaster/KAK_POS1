...
/// Warning/pending color for a pre-payment bill's "UNPAID" status — mirrors
  ...
  pw.Widget _receiptPageContent(
    ...
    return pw.Column(
      ...
      children: [
        ...
        // ── Invoice metadata ──
        _metadataRow(
          r.isBill ? labels.ticket : labels.invoiceNumber,
          r.invoiceNumber,
          t,
        ),
