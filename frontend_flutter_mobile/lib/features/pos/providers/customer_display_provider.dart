...
/// customer_display_provider.dart` — COPY/ADAPT NEARLY EXACTLY. Only
/// `broadcastCartState`'s field reads are adapted to mobile's `CartState`/
/// `CartItem` (same field names as source: `total` is the pre-tax/discount
/// subtotal, `finalTotal` is the grand total — see cart_provider.dart).
///
...
/// — this must stay a completely optional, non-blocking add-on, so no
/// call site ever awaits these methods.
