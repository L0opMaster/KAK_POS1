...
/// qty_stepper.dart` — COPY/ADAPT NEARLY EXACTLY.
      ...
      child: Row(
        ...
        children: [
          InkWell(
            ...
            borderRadius:
                BorderRadius.horizontal(left: Radius.circular(PosTheme.radiusSmall)),
            child: Container(
              width: 32,
              height: 32,
          ...
          InkWell(
            onTap: onIncrement,
            borderRadius:
                BorderRadius.horizontal(right: Radius.circular(PosTheme.radiusSmall)),
            child: Container(
              width: 32,
              height: 32,
              alignment: Alignment.center,
