/// Ported from `frontend-flutter-pos/lib/features/reports/models/
/// report_models.dart` — COPY/ADAPT NEARLY EXACTLY, full file.
/// Report models for the POS reports module. Matches the backend DTOs in
/// ReportDtos.java.
library;
...
class PaymentBreakdown {
  ...
  PaymentBreakdown({required this.method, this.total = 0, this.count = 0});
  ...
  factory DailyReportResponse.fromJson(Map<String, dynamic> json) =>
      DailyReportResponse(
        summary: json['summary'] != null
            ? DailySalesSummary.fromJson(json['summary'] as Map<String, dynamic>)
            : null,
        topProducts:
            ...
            [],
        cashiers:
            (json['cashiers'] as List<dynamic>?)
                ?.map(
                  (e) => CashierPerformance.fromJson(e as Map<String, dynamic>),
                )
                .toList() ??
            [],
        payments:
...
class SalesSummaryReportResponse {
  ...
  factory SalesSummaryReportResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (rawRows is Map<String, dynamic>) {
      ...
      rows =
          (rawRows['content'] as List<dynamic>?)
    ...
    return SalesSummaryReportResponse(
      ...
      totals: json['totals'] != null
          ...
          : null,
      cashierBreakdown:
          (json['cashierBreakdown'] as List<dynamic>?)
              ?.map(
                (e) => CashierPerformance.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
...
class SalesReportSummary {
  ...
  factory SalesReportSummary.fromJson(Map<String, dynamic> json) =>
      SalesReportSummary(
        ...
        averageSaleAmount:
            (json['averageSaleAmount'] as num?)?.toDouble() ?? 0,
      );
}
...
class SalesReportResponse {
  ...
  factory SalesReportResponse.fromJson(Map<String, dynamic> json) {
    ...
    if (rawSales is Map<String, dynamic>) {
      sales =
          (rawSales['content'] as List<dynamic>?)
    ...
    return SalesReportResponse(
      summary: json['summary'] != null
          ? SalesReportSummary.fromJson(json['summary'] as Map<String, dynamic>)
          : null,
      sales: sales,
      salesMeta: salesMeta,
      paymentBreakdown:
          (json['paymentBreakdown'] as List<dynamic>?)
              ?.map(
                (e) => PaymentBreakdown.fromJson(e as Map<String, dynamic>),
              )
              .toList() ??
...
class MonthlySales {
  ...
  MonthlySales({required this.month, this.total = 0, this.count = 0});
  ...
  factory TaxRangeReportResponse.fromJson(Map<String, dynamic> json) =>
      TaxRangeReportResponse(
        ...
        rows:
            ...
            [],
        meta: PageMeta.fromJson(json),
        totalTaxCollected: (json['totalTaxCollected'] as num?)?.toDouble() ?? 0,
      );
}
