...
abstract class AppLocalizations {
  ...
  /// No description provided for @navCatalogManagement.
  ///
  /// In en, this message translates to:
  /// **'Catalog Management'**
  String get navCatalogManagement;
  ...
  /// No description provided for @cartSummaryBarViewCart.
  ///
  /// In en, this message translates to:
  /// **'View Cart'**
  String get cartSummaryBarViewCart;

  /// No description provided for @barcodeScannerScreenTitle.
  ///
  /// In en, this message translates to:
  /// **'Scan Barcode'**
  String get barcodeScannerScreenTitle;
  ...
  /// No description provided for @categoryManagementSaving.
  ///
  /// In en, this message translates to:
  /// **'Saving...'**
  String get categoryManagementSaving;
