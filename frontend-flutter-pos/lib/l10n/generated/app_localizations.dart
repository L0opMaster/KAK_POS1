...
abstract class AppLocalizations {
  ...
  /// No description provided for @paymentScreenHeldTicketReleaseFailed.
  ///
  /// In en, this message translates to:
  /// **'Payment succeeded, but held ticket #{ticketId} could not be closed automatically — please delete it manually from Held Tickets.'**
  ...
  /// No description provided for @posDrawerHeldTicketsColumnTicket.
  ///
  /// In en, this message translates to:
  /// **'Ticket #'**
  String get posDrawerHeldTicketsColumnTicket;
  ...
  /// No description provided for @heldTicketsItemsCount.
  ///
  /// In en, this message translates to:
  /// **'{count} items'**
  ...
  /// No description provided for @tableSelectorSelectedLabel.
  ///
  /// In en, this message translates to:
  /// **'Selected: {table}'**
  String tableSelectorSelectedLabel(Object table);

  /// No description provided for @tableSelectorNoneSelected.
  ///
  /// In en, this message translates to:
  /// **'No table selected'**
  String get tableSelectorNoneSelected;
