...
/// Preview for a held ticket's pre-payment bill, pushed from
/// `held_tickets_dialog.dart`'s "Print Bill" action — the same
/// preview-before-print step [ReceiptPreviewScreen] already gives the
/// final paid receipt, kept as a separate (simpler) screen since a bill has
/// no splits/payment-method inputs to carry.
///
