...
/// State for cash event list screen.
...
/// Notifier that manages cash events.
...
/// Provider for the cash event state notifier.
final cashEventProvider =
    StateNotifierProvider<CashEventNotifier, CashEventState>((ref) {
  final CashEventService service = ref.read(cashEventServiceProvider);
