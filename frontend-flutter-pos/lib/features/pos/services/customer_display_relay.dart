...
///
/// Mirrors `ScannerRelayClient` (scanner_relay_role.dart) but instead of one
/// fixed message shape (`barcode`), the POS side pushes arbitrary typed
/// JSON payloads (`sendJson`) describing live cart/checkout state.
